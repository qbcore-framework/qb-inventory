...
RegisterNetEvent('inventory:server:LoadDrops', function()
	local src = source
...
QBCore.Commands.Add("resetinv", "Reset Inventory (Admin Only)", {
	{name = "type", help = "stash/trunk/glovebox"},
	{name = "id/plate", help = "ID of stash or license plate"}
